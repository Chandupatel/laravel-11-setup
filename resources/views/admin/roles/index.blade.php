...
@section('content')
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-shrink-0">
                                <a href="javascript:void(0);"class="btn btn-outline-primary waves-effect waves-light"
                                    onclick="openCrateEditModal('{{ route('admin.roles.create') }}')">Add New Role</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body border-bottom">
    ...
    <div id="rolesAddEditModal" class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog"
    ...
    <script type="text/javascript">
        function openCrateEditModal(url) {
            callGetRequest(url, [], function(response) {
                openFormModal("#rolesAddEditModal", "#modalContentSection", response);
            });
        }
        ...
        function submitPostForm(form_id) {
            if (checkFormValidation(form_id)) {
                ...
                callPostRequest(url, data, function(response) {
                    hendalFormResponse(form_id, response, "#rolesAddEditModal", "roleDataTable")
                })
            }
        }
    </script>

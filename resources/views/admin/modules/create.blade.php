<div class="modal-content">
    <form method="POST" action="{{ route('admin.modules.store') }}" id="PostForm">
        <div class="modal-header">
            <h5 class="modal-title" id="myLargeModalLabel">Create Module</h5>
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="text" name="active_cases" class="form-control" id="formrow-active_cases-input"
                            placeholder="Enter Active Cases" value="" required>
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="text" name="icon" class="form-control" id="formrow-icon-input"
                            placeholder="Enter Icon" value="" required>
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="text" name="route_name" class="form-control" id="formrow-route_name-input"
                            placeholder="Enter Route Name" value="" required>
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="text" name="route_params" class="form-control" id="formrow-route_params-input"
                            placeholder="Enter Route Params" value="">
